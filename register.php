...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($_POST['phone'])) {
		...
		$t = mysqli_real_escape_string($dbc, trim($_POST['phone']));
	}
	...
	if (empty($errors)) { // If everything's OK.
		...
		// Make the query:
		$q = "INSERT INTO users (first_name, last_name, address, phone, email, pass, registration_date, role) VALUES ('$fn', '$ln', '$a', '$t','$e', SHA1('$p'), NOW(), 'CLIENT')";		
...
<div class="content">
	...
	<fieldset><legend style="font-size:small">Enter your information in the form below:</legend>
			...
			<p>
				...
				<input id="address" type="text" name="address" value="<?php if (isset($_POST['address'])) echo $_POST['address']; ?>">
			</p>
			<p>
